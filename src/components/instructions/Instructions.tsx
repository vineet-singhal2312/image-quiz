...
export default function Instructions() {
  ...
  return (
    <div id="instructions">
      ...
      >
        <AccordionSummary
          expandIcon={<ExpandMoreIcon id="down-arrow"/>}
        ...
        <AccordionDetails>
          <Typography id="instruction-list">
            <ul>
              ...
              <li>In every question you have to find correct image of the company website.</li>
              <li>Each question has 1 correct Image and 1 wrong image.</li>
            </ul>
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      >
        ...
        <AccordionDetails>
          <Typography id="instruction-list">
            <ul>
              <li>Each correct answer carry 1 points.</li>
              <li>Each incorrect answer carry 0 point.</li>
              <li>
        ...
        <AccordionDetails>
          <Typography id="instruction-list">
            <ul>
              <li>
                {" "}
                You have 15 second for each question, Next question will be
                appear automatically after 15 second.
              </li>
            </ul>
          </Typography>
        </AccordionDetails>
